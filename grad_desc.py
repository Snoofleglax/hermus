...
def MakeOrbit(x):
  ...
  while chibindex < npoints:
    ...
    #bdev.write(str(chibnum) + " " + str(obsdata[chibindex,0]) + "\n")
  ...
  while chivgsrindex < npoints:
    ...
    #vdev.write(str(chivgsrnum) + " " + str(obsdata[chivgsrindex,0]) + "\n")
  ...
  while chirindex < npoints:
    ...
    #rdev.write(str(chirnum) + " " + str(obsdata[chirindex,0]) + "\n")
...
x0 = np.asarray((47.08,11.48,-101.64,136.68,60.39))
